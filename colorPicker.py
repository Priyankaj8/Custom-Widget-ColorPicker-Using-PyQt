...
class MainWindow(QWidget):
    ...
    def initUI(self):
        ...
        # Creating layout for the main window
        ...
        # Creating a label for previewing the color
        ...
        # Setting the initial value of the color
        self.color="#ffffff"
    ...
    def show_color_dialog(self, event):
        if event.button() == Qt.MouseButton.LeftButton:
            color_dialog = QColorDialog(self.color)
